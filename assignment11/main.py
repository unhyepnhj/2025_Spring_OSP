...
# data_dir = r"C:\Users\rdh08\PycharmProjects\openSWproject\VOCdevkit\VOC2012"
...
criterion = nn.CrossEntropyLoss()   # p7: CSE
# Optimizer
##### fill in here -> hint : set the Optimizer #####
optimizer = torch.optim.Adam(model.parameters(), lr=learning_rate)  # p7: Adam
...
date = now.strftime('%Y-%m-%d(%H-%M)')  # 수정
...
for epoch in range(epochs):
    ...
    if epoch % 4 == 0:
        ...
        print(f"Saved checkpoint: {savepath2}") # 출력
