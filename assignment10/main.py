...
PATH = 'checkpoints/resnet50_epoch285.ckpt'  # test acc would be almost 80

# model = vgg16().to(device)
# PATH = 'checkpoints/vgg16_epoch250.ckpt'  # test acc would be almost 85
##############################################################
